...
const CreateSchedule = () => {
  ...
  const scheduleId = params.get('id'); // สำหรับ edit
    ...
    if (mode === 'edit' && scheduleId) {
      axiosInstance.get(`/schedules/${scheduleId}`)
        ...
        .catch(err => {
          ...
          alert('ไม่สามารถโหลดข้อมูลตารางเวลาได้');
          navigate('/admin/schedule');
        });
    } else {
      setLoading(false);
    }
  }, [mode, scheduleId, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === 'edit') {
        await axiosInstance.put(`/schedules/${scheduleId}`, formData);
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3">
          ...
          >
            ...
            <option value="Yoga">โอม</option>
            <option value="Cardio">นาย</option>
            <option value="Strength">สมหมาย</option>
          </Form.Select>
        </Form.Group>
